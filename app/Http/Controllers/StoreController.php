...
class StoreController extends Controller {
    ...
    public function index() 
    {
        ...
        return view("pages.store.store", compact(['categories', 'brand_categories', 'top_selling', 'products', 'total_price', 'total_item', 'cart_item']));
    }
    public function show(Request $request) 
    {
        ...
        return view("pages.store.store", compact(['categories', 'brand_categories', 'top_selling', 'products']));
    }
    public function update(Request $request) 
    {
        ...
        return view("pages.store.search", compact(['categories', 'brand_categories', 'top_selling', 'products']));
    }
