...
class CartController extends Controller {
    ...
    {
        $this->validate($request, ['products_id' => 'required', 'name' => 'required', 'image' => 'required', 'price' => 'required', 'size' => 'required', 'color' => 'required', 'number' => 'required']);
        ...
        $cart_model = Cart::create(['products_id' => $products_id, 'name' => $name, 'image' => $image, 'price' => $price, 'size' => $size, 'color' => $color, 'number' => $number]);
